...
function sliderSlide(wrap, obj) {
    ...
    function slide() {
        ...
        if (flag != 0 && index == iTimes) {
            startMove(obj, {
                left: -speed * ((index - 1) * curNum + flag)
...
function popupDialog() {
    ...
    oDialog.className = "popup-dialog";
    oDialog.id = "popup-dialog";
...
function show(obj) {
    var oDialog = document.getElementById('popup-dialog');
    ...
    startMove(oDialog, {
        ...
        startMove(oDialog, {
            ...
            oClose.className = "popup-close";
            oClose.id = "popup-close";
            oClose.innerHTML = "关闭";
